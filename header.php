        ...
        <div class="right">
            ...
            <form action="#" method="get" id="searchFrm">
                <fieldset>
                    ...
                    <input type="text" placeholder="상품명을 입력해주세요" id="searchTxt">
                    <button type="submit" id="searchBtn"><img src="./images/icon_search.png" alt="검색"></button>
                </fieldset>
            </form>
            <a href="./login.html" id="login"><img src="./images/icon_user.png" alt="로그인"></a>
            <a href="./review.html" id="cart"><img src="./images/icon_shopping.png" alt="장바구니"></a>
